...
from optim import plot_optim, run_optim
...
def fit_model[Params: chex.ArrayTree](
    init_params: Params,
...
fitted_constant_intensity_params = fit_model(
...
fitted_hawkes_params = fit_model(
...
fitted_rbf_hawkes_params = fit_model(
...
fitted_power_law_hawkes_params = fit_model(
